...
# Progress: xx/100%  
# Done: 
Broken Leg System (With Visuals And More Realism) 
- Higher Chance Of Broken Leg In Higher Damage Weapons 
- Tripping Animation When Running Or Jumping 
- When Using PainKillers It Can Cure The Broken Leg 

Vest Plate System (With Visuals) 
- /vest To Use Vest 
- Only 25 Armour Will Be Added Per Vest 
- Simple Vest Wearing Animation (There Is No Existing Realistic Wearing Of Vest In SA:MP/Open.MP)
- When Using Vest There Is A Progress Bar Will Appear 
- Player Can't Move When Wearing Vest 

Not Allowed Weapons Kicker (Adjusted) These Are The Only Weapons Allowed In The Server: 
- 9MM 
- Silenced 9MM 
- Shotgun 
- MP5 
...
Business Gunshop Items (Adjusted) 
- Chainsaw 
- Katana 
- Pool Cue
- Shovel 
...
BlackMarket Items And Price List (Adjusted): 
- Clean Money ($2 Dirty Money = $1 Clean Money) 
- Dirty Money ($20 Clean Money = $5 Dirty Money) 
- C4 ($10,000 Dirty Money, 150 Metal Scraps) 
- Digital Safe Cracker ($5,000 Dirty Money, 50 Metal Scraps) 
- Molotov ($100 Dirty Money) 
- Dessert Eagle ($100 Dirty Money)
- 9MM ($1,000 Dirty Money) 
- Silenced 9MM ($5,000 Dirty Money) 
- Shotgun ($3,000 Dirty Money) 
...
- Tomato (Burger) ($25 = 1 Tomato) 
- Onion (Burger) ($25 = 1 Onion) 
...
- Water (+25% Add To Thirst) 
- Combo Burger And Water (+100% Hunger, +100% Thirst) (Ingredients: 2 Lettuce, 2 Tomato, 2 Onion, 2 Cucumber) 
- Sellable by Burger Faction

Coffee Faction: 
- Cookies (+25% Hunger) (Ingredients: 1 Cocoa Beans) 
- Coffee (+25% Thirst, +100% Stress) (Ingredients: 3 Coffee Beans) 
...
- Personal Stash? (No Description) 
- Clothes? (No Description)

Crafting Table System: 
- Weapon Body Parts (Purchaseable by Raw Materials)
- Required Raw Materials Per Body Parts (Above 20 Each And Randomized) 
- Required Tool To Craft Specific Weapons
- 2-Minutes Weapon Crafting Process (When Move Crafting Process Will Be Cancelled Automatically) 
- With Visuals (ProgressBars or Any)

Spray Tag System: 
- Spray Can (Purchaseable At 24/7 Business)
- Allowed Carry For Gang Members Only 
- 60-Seconds With Animation When Spraying
- Placeable Anywhere
